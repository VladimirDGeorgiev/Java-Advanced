package JavaOOP.L09ReflectionAndAnnotations.Exercises.p04BarracksWarsTheCommandsStrikeBack.barracksWars.data;
...
public class UnitRepository implements Repository {
	...
	public void removeUnit(String unitType) throws ExecutionControl.NotImplementedException {
		...
		if (this.amountOfUnits.get(unitType)==null){
		...
		//}else if (this.amountOfUnits.get(unitType)==1){
